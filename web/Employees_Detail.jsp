                            ...
                            <div class="woocommerce">
                                ...
                                <center>  
                                    ...
                                    <table cellspacing="1" cellpadding="1" border="1" id="customers">
                                        ...
                                        <tr>
                                            <th>Employee ID</th><th>Employee Name</th><th>Email</th><th>Mobile</th><th>Tag</th><th>DOB</th><th>DOJ</th><th>Department</th><th>Status</th>                                       
                                        ...
                                        <tr>
                                            <td><%=eid%></td><td><%=ename%></td><td><%=email%></td><td><%=mobile%></td>
                                            <td><%=tag%></td><td><%=dob%></td><td><%=doj%></td><td><%=dept%></td>
                                        
                                           
<!--                                            <td>
                                                <input type="submit" name="submit" value="Update"/>
                                            </td>-->
                                          <form action="track_employee.jsp" method="post">
                                        ...
                                        <form action="feedback_employee.jsp" method="post">
                                               <input type="hidden" name="eid" value="<%=eid%>"/> 
                                               <input type="hidden" name="ename" value="<%=ename%>"/> 
                                                 <td>
                                        ...
                                        <form action="apply_insurance.jsp" method="post">
                                               <input type="hidden" name="eid" value="<%=eid%>"/> 
                                ...
                                <input type="hidden" name="dept" value="<%=dept%>"/>
                                                 ...
                                                 <td>
                                                <input type="submit" name="submit" value="Apply Insurance"/>
