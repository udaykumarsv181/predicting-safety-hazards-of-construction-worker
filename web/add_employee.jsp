                        ...
                        <ul class="nav navbar-nav">
                           <li ><a href="admin_home.jsp">Home</a></li>
                            ...
                            <li><a href="Device_Detail.jsp">Device Details</a></li>
                              <li class="active"><a href="add_employee.jsp">Add Employees</a></li>    
                                                        ...
                                                        <form action="./add_employee"  method="post" >
                                                            <table >
                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="eid" id="eid" style="width: 200px" required/>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="mobile" id="mobile" style="width: 200px" required/>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="date" name="doj" id="doj" style="width: 200px"/>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Department</td>
